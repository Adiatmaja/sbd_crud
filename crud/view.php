...
$row = query("SELECT pesanan.kode_pesanan, member.kode_member, member.nama, pesanan.tanggal_order, penerbangan.kode_penerbangan, bandara.nama_bandara, penerbangan.tanggal_depart, penerbangan.waktu_depart, penerbangan.waktu_arrive, penerbangan.kelas, pesanan.harga FROM pesanan
